...
public final class SecurityConstants {
	...
	public static final class AuthenticationWhiteList {
		...
		public static final String[] USER_API = {"/api/user/members/check", "/api/user/members/register", "/api/user/members/login", "/login", "/index.html", "/", "/test-api.html", "/admin.html", "/api/maps/key"}; // NOTE : api/maps/key" 이거 일단 여기 넣어둠
