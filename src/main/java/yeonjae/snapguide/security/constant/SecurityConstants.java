...
public final class SecurityConstants {
	...
	public static final class AuthenticationWhiteList {
		public static final String[] TEST_API = {"/test/**", "/guide/api/nearby/**", "/api/auth/reissue"}; // "/api/auth/test",
		...
		public static final String[] LOCAL_LOGIN_API = {"/api/auth/signup", "/api/auth/login", "/api/auth/reissue", "/api/auth/google/token"};
