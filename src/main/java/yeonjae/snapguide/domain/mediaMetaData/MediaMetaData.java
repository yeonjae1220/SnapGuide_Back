package yeonjae.snapguide.domain.mediaMetaData;

import jakarta.persistence.*;
import lombok.*;
import yeonjae.snapguide.domain.cameraModel.CameraModel;
import yeonjae.snapguide.domain.media.mediaUtil.exifUtil.FlashMode;
import yeonjae.snapguide.domain.media.mediaUtil.exifUtil.WhiteBalance;
